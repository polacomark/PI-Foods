...
const apiData=async ()=>{
    ...
    const apiUrl=await axios.get(
        `https://api.spoonacular.com/recipes/complexSearch?apiKey=966251fd45854d77ae1336adfe8ecbfc&number=100&addRecipeInformation=true&number=true`
        )
  ...
  router.get('/recipes', async (req,res) => {
    ...
    if (name){
        ...
        const resAxios = await axios.get(
          `https://api.spoonacular.com/recipes/complexSearch?query=${name}&addRecipeInformation=true&number=100&apiKey=966251fd45854d77ae1336adfe8ecbfc`
        )
...
//     const {id} = req.params;  
//     const recipeid = axios.get(`https://api.spoonacular.com/recipes/${id}/information?apiKey=e0586914534b4287be67df5b517bb120`)
...
//             ? res.analyzedInstructions[0]
//             : null,
//             diets: res.diets.map(e=>e.diets)
//         }
//         return recipe;
//     })  
//     .catch((err)=>{
